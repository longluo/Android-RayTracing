...
extern "C"
JNIEXPORT void JNICALL Java_me_longluo_raytracing_LibRayTracer_initialize(JNIEnv * env, jobject obj, jobject mBitmap) {
...
extern "C"
JNIEXPORT void JNICALL Java_me_longluo_raytracing_LibRayTracer_passLightProbe(JNIEnv * env, jobject obj, jobject mBitmap) {
...
extern "C"
JNIEXPORT void JNICALL Java_me_longluo_raytracing_LibRayTracer_passBackground(JNIEnv * env, jobject obj, jobject mBitmap) {
...
extern "C"
JNIEXPORT jint JNICALL Java_me_longluo_raytracing_LibRayTracer_rayTrace(JNIEnv * env, jobject obj, jobject mBitmap, jlong timeElapsed) {
...
extern "C"
JNIEXPORT void JNICALL Java_me_longluo_raytracing_LibRayTracer_setInterlacingEnabled(JNIEnv * env, jobject obj, jboolean enabled) {
	if (enabled) {
		interlace_lines = 2;
	} else {
		interlace_lines = 1;
...
extern "C"
JNIEXPORT void JNICALL Java_me_longluo_raytracing_LibRayTracer_setReflectionsEnabled(JNIEnv * env, jobject obj, jboolean enabled) {
	if (scene) {
