...
public class Chapter3_SphereActivity extends AppCompatActivity implements OnRayTracingListener<String> {

    protected static final String CURRENT_MODULE = "Chapter3";
    ...
    private RayTracing3 mRayTracing;
    ...
    private void initData() {
        mTopBar.setTitle("Chapter 3 a Red Sphere");
        ...
        mRayTracing = new RayTracing3(Constants.IMAGE_WIDTH, Constants.IMAGE_HEIGHT, CURRENT_MODULE);
    ...
    public void onConvertSuccess(String result) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Glide.with(Chapter3_SphereActivity.this).load(file).into(mIvResult);
            }
        });
    }
