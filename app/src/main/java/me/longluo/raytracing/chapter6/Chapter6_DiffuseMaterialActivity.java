package me.longluo.raytracing.chapter6;
...
public class Chapter6_DiffuseMaterialActivity extends AppCompatActivity implements OnRayTracingListener<String> {

    protected static final String CURRENT_MODULE = "Chapter6";
    ...
    private RayTracing6 mRayTracing;
    ...
    private void initData() {
        mTopBar.setTitle("Chapter 6 Diffuse Materials");
        ...
        mRayTracing = new RayTracing6(Constants.IMAGE_WIDTH, Constants.IMAGE_HEIGHT, CURRENT_MODULE);
    ...
    public void onConvertSuccess(String result) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Glide.with(Chapter6_DiffuseMaterialActivity.this).load(file).into(mIvResult);
            }
        });
    }
