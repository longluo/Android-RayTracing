...
public class Chapter9_CameraActivity extends AppCompatActivity implements OnRayTracingListener<String> {

    protected static final String CURRENT_MODULE = "Chapter9";
    ...
    private void initData() {
        mTopBar.setTitle("Chapter 9  Camera");
    ...
    public void onConvertSuccess(String result) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Glide.with(Chapter9_CameraActivity.this).load(file).into(mIvResult);
            }
        });
    }
