...
public class Chapter8_DielecticActivity extends AppCompatActivity implements OnRayTracingListener<String> {

    protected static final String CURRENT_MODULE = "Chapter8";
    ...
    private void initData() {
        mTopBar.setTitle("Chapter 8 Dielectic");
...
//        mRayTracing = new RayTracing(Constants.IMAGE_WIDTH, Constants.IMAGE_HEIGHT, CURRENT_MODULE);
        mRayTracing = new RayTracing(1000, 800, CURRENT_MODULE);
    ...
    public void onConvertSuccess(String result) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Glide.with(Chapter8_DielecticActivity.this).load(file).into(mIvResult);
            }
        });
    }
