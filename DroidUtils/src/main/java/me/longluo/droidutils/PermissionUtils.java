...
import me.longluo.droidutils.constant.PermissionConstants;

import static me.longluo.droidutils.constant.PermissionConstants.PermissionGroup;
...
public final class PermissionUtils {
    ...
    public static boolean isGranted(final Context context, final String... permissions) {
        Pair<List<String>, List<String>> requestAndDeniedPermissions = getRequestAndDeniedPermissions(context, permissions);
    ...
    private static Pair<List<String>, List<String>> getRequestAndDeniedPermissions(Context context, final String... permissionsParam) {
        List<String> requestPermissions = new ArrayList<>();
        List<String> deniedPermissions = new ArrayList<>();
        List<String> appPermissions = getPermissions(context);
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public static void requestDrawOverlays(final Context context, final SimpleCallback callback) {
    ...
    public void request(Context context) {
        ...
        Pair<List<String>, List<String>> requestAndDeniedPermissions = getRequestAndDeniedPermissions(context, mPermissionsParam);
    ...
    static final class PermissionActivityImpl extends UtilsTransActivity.TransActivityDelegate {
        ...
        public void onDestroy(@NonNull final UtilsTransActivity activity) {
            if (currentRequestCode != -1) {
                checkRequestCallback(activity, currentRequestCode);
        ...
        private void checkRequestCallback(Context context, int requestCode) {
