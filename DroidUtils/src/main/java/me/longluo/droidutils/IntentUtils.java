...
public final class IntentUtils {
     ...
     * @return the intent of launch app
     */
    public static Intent getLaunchAppIntent(final Context context, final String pkgName) {
        String launcherActivity = ActivityUtils.getLauncherActivity(context, pkgName);
     ...
     * @return the intent of share image
     */
    public static Intent getShareImageIntent(final Context context, final String imagePath) {
        return getShareTextImageIntent(context, "", imagePath);
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareImageIntent(final Context context, final File imageFile) {
        return getShareTextImageIntent(context, "", imageFile);
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareTextImageIntent(final Context context, @Nullable final String content, final String imagePath) {
        return getShareTextImageIntent(context, content, FileUtils.getFileByPath(imagePath));
    }
     ...
     * @return the intent of share image
     */
    public static Intent getShareTextImageIntent(final Context context, @Nullable final String content, final File imageFile) {
        return getShareTextImageIntent(content, UriUtils.file2Uri(context, imageFile));
    }
     ...
     * @return the intent of share images
     */
    public static Intent getShareImageIntent(final Context context, final LinkedList<String> imagePaths) {
        return getShareTextImageIntent(context, "", imagePaths);
    }
     ...
     * @return the intent of share images
     */
    public static Intent getShareImageIntent(final Context context, final List<File> images) {
        return getShareTextImageIntent(context, "", images);
    }
     ...
     * @return the intent of share images
     */
    public static Intent getShareTextImageIntent(final Context context, @Nullable final String content,
        ...
        return getShareTextImageIntent(context, content, files);
    }
     ...
     * @return the intent of share images
     */
    public static Intent getShareTextImageIntent(final Context context, @Nullable final String content, final List<File> images) {
        ArrayList<Uri> uris = new ArrayList<>();
        if (images != null) {
            for (File image : images) {
                Uri uri = UriUtils.file2Uri(context, image);
                if (uri != null) {
                    uris.add(uri);
                }
            }
